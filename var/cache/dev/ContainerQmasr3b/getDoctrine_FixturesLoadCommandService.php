...
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/PostFixtures.php';
...
$a->addFixtures(array(0 => new \AppBundle\DataFixtures\PostFixtures(${($_ = isset($this->services['AppBundle\Service\Blog\PostService']) ? $this->services['AppBundle\Service\Blog\PostService'] : $this->load(__DIR__.'/getPostServiceService.php')) && false ?: '_'})));
