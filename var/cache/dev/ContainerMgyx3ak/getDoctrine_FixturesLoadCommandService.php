...
$a->addFixtures(array(0 => new \AppBundle\DataFixtures\AppFixtures(${($_ = isset($this->services['AppBundle\Service\Blog\PostService']) ? $this->services['AppBundle\Service\Blog\PostService'] : $this->load(__DIR__.'/getPostServiceService.php')) && false ?: '_'})));
